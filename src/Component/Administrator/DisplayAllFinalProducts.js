    ...
    const fetchAllProducts = async()=>{
      ...
      const fillProducts=()=>{
        return productList.map((item)=>{
          return <MenuItem value={item.productname}>{item.productname}</MenuItem>
        })
      }
      const fillColors=()=>{
        return colorList.map((item)=>{
          return <MenuItem value={item.colorname}>{item.colorname}</MenuItem>
        })
      }
          ...
          <Button variant="contained" color="primary" style={{background:"#22a6b3" }} fullWidth onClick={()=>handleSubmit()} >Edit Final Product</Button>
            ...
            function SimpleAction() {
              ...
              return (
                ...
                title={ <><span>
                  <img alt="" src="/glasskart.png" width="40" />
                </span> <b style={{fontSize:18,opacity:0.5}}>DISPLAY FINAL PRODUCT </b> &nbsp; 
                    <Button
                  variant="contained"
                  color="primary"
                  size="small"
                  ...
                  startIcon={<AddIcon />}
                  onClick={()=>props.setComponent(<AddFinalProducts/>)}
                >
                 Add Final Product
                </Button></>}               
                   columns={[
                    ...
                    { title: 'Product Name',
                    render: rowData =><div><b>{rowData.productid}</b></div>},
                    { title: 'Color', 
                     render: rowData =><div>{rowData.colorid}</div>},
                    { title: 'Size', 
