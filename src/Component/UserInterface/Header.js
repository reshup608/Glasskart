...
export default function Header(props) {
  ...
  var actualamount=products.reduce(calculateActualAmount,0)
  var savingamount=products.reduce(savingAmount,0)
...
const list = (anchor) => (
  ...
  >
    ...
    <divider/>
    {key.length==0?<div style={{width:345,display:'flex',justifyContent:'center',alignContent:'center'}}><img src="/emptycart.jpg"/></div>:
    <>
   <div style={{width:345}}>
    ...
    <div style={{width:345}}>
     ...
     <span style={{fontWeight:600,float:'right',padding:5}}>&#8377; -{savingamount}</span>
