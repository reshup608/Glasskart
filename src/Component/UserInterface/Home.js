      ...
      const DisplayMainPageImages = () => {
        return list.map((item) => {
          return (<div style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
              ...
              <Button variant="contained" style={{width:250,borderRadius:0, position:'absolute',left:'70%',top:'50%',background:'#50526E',color:'#FFF'}}>Shop Sunglasses</Button>
              <Button variant="contained" style={{width:250,borderRadius:0, position:'absolute',left:'70%',top:'58%',background:'#50526E',color:'#FFF'}}>Shop Eyeglasses</Button>
